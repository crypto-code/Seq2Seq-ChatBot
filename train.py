...
if __name__ == "__main__":
    ...
    elif not os.path.exists('model_'+data_corpus+'/'):
            os.mkdir('model_'+data_corpus+'/')
    ...
    for epoch in range(num_epochs):
        ...
        tl.files.save_npz(model_.all_weights, name='model_{}/model_{}_{:.4f}.npz'.format(data_corpus, epoch+1, total_loss / n_iter))  
